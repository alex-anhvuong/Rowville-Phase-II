...
let stepsContent = [
  //First object that stores the content for Step 1 
  {
    ...
    contentList: [
      ...
      {
        isVideoLink: false,
        contentData: ["For more information on SWOT analysis watch a quick video on it and to download a fee template to complete a swot analysis for yourself "],
        style: "None",
        tagType: "span",
        isBold: false,
        isUnderLine: false,
  ...
  //content stored for Step 4
  {
    ...
    contentList: [
      ...
      {
        isVideoLink: false,
        contentData: ["Click below to open the template."],
        style: "None",
        tagType: "span",
        isBold: false,
        isUnderLine: true,
  ...
  contentList: [
    ...
    {
      isVideoLink: false,
      contentData: ["To watch a few useful short videos on developing a business plan by 3 major banks click below", "Developing a business plan by Commonwealth Bank"],
      style: "None",
      tagType: "p",
      isBold: false,
      isUnderLine: false,
  ...
  //content stored for step 6
  {
    ...
    contentList: [
      ...
      {
        isVideoLink: false,
        contentData: ["click the link below."],
        style: "None",
        tagType: "span",
        isBold: false,
        isUnderLine: true,
  ...
  },
  {
    ...
    contentList: [
      ...
      {
        isVideoLink: false,
        contentData: ["To register your domain name click below."],
        style: "None",
        tagType: "p",
        isBold: false,
        isUnderLine: false,
  ...
  contentList: [
    ...
    {
      isVideoLink: false,
      contentData: ["There are lots of different ways to advertise your business. Some common ways for a new business can include:", "Having a website and internet presence", "On social media such as face book, instagram and Twitter.", "Look at using Google Adwords and or create a Google place listing.", "Networking going to local business or marketing events, trade shows, workshops, seminars", "Create your own event.", "Newspapers, trade magazines, brochures", "Creating flyers or posters", "Place an ad on a local radio station"],
      style: "None",
      tagType: "p",
      isBold: false,
      isUnderLine: false,
  ...
  contentList: [
    {
      isVideoLink: false,
      contentData: ["Starting a business for the first time usually means there’s a lot to learn and we sometimes need help with parts of setting up a business that you might not have much experience with. The good news is that there is so much help and support available for almost every aspect of your business so you don’t have to do it alone.", "The even better news is that most of the help and support available can be found locally in your area, is low cost and in some cases even free.", "A great place to start is with your closest Learn Local training centre. Learn Local organisations offer government subsidised short courses and workshops. With more Learn Local’s across Victoria than there is McDonald’s your sure to find one near you. Click below to find your nearest Learn Local."],
      style: "None",
      tagType: "p",
      isBold: false,
      isUnderLine: false,
  ...
  //content stored for step 12
  {
    ...
    contentList: [
      ...
      {
        isVideoLink: false,
        contentData: ["For more information on workers compensation insurance click below."],
        style: "None",
        tagType: "span",
        isBold: false,
        isUnderLine: false,
  ...
  //content stored for step 9
  {
    ...
    contentList: [
      ...
      {
        isVideoLink: false,
        contentData: ["Click on the links below"],
        style: "None",
        tagType: "span",
        isBold: false,
        isUnderLine: true,
